...
void CyEnumsPythonInterface() {
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		.value("WIDGET_HELP_FOREST_YIELD_CHANGE", WIDGET_HELP_FOREST_YIELD_CHANGE)
		.value("WIDGET_HELP_RIVER_YIELD_CHANGE", WIDGET_HELP_RIVER_YIELD_CHANGE)
		.value("WIDGET_HELP_SEA_YIELD_CHANGE", WIDGET_HELP_SEA_YIELD_CHANGE)
		.value("WIDGET_HELP_CAPTURE_CITIES", WIDGET_HELP_CAPTURE_CITIES)
		.value("WIDGET_HELP_FIRST_FREE_UNIT", WIDGET_HELP_FIRST_FREE_UNIT)
		.value("WIDGET_HELP_OBSOLETE_BUILD", WIDGET_HELP_OBSOLETE_BUILD)
		.value("WIDGET_HELP_EMBASSY", WIDGET_HELP_EMBASSY)
		.value("WIDGET_HELP_LIMITED_BORDERS", WIDGET_HELP_LIMITED_BORDERS)
		...
		.value("WIDGET_HELP_WEAPON_TYPE", WIDGET_HELP_WEAPON_TYPE)
	...
	python::enum_<ButtonPopupTypes>("ButtonPopupTypes")
		...
		.value("BUTTONPOPUP_GOTO_CITY", BUTTONPOPUP_GOTO_CITY)
		.value("BUTTONPOPUP_TOGGLE_WORLD_VIEW", BUTTONPOPUP_TOGGLE_WORLD_VIEW)
		.value("BUTTONPOPUP_TOGGLE_ANY_WORLD_VIEW", BUTTONPOPUP_TOGGLE_ANY_WORLD_VIEW)
		.value("BUTTONPOPUP_SLAVE_REVOLT", BUTTONPOPUP_SLAVE_REVOLT)
		.value("BUTTONPOPUP_SELECT_UNIT", BUTTONPOPUP_SELECT_UNIT)
		.value("BUTTONPOPUP_SELECT_DISCOVERY_TECH", BUTTONPOPUP_SELECT_DISCOVERY_TECH)
	...
	python::enum_<UnitAITypes>("UnitAITypes")
		...
		.value("UNITAI_BARBARIAN_LEADER", UNITAI_BARBARIAN_LEADER)
		.value("UNITAI_BARBARIAN", UNITAI_BARBARIAN)
		.value("UNITAI_BARBARIAN_ATTACK_CITY", UNITAI_BARBARIAN_ATTACK_CITY)
		.value("UNITAI_JESTER", UNITAI_JESTER)
	...
	python::enum_<AutomateTypes>("AutomateTypes")
		...
		.value("AUTOMATE_CITY_DEFENCE", AUTOMATE_CITY_DEFENCE)
		.value("AUTOMATE_BORDER_PATROL", AUTOMATE_BORDER_PATROL)
		.value("AUTOMATE_PIRACY", AUTOMATE_PIRACY)
	...
	python::enum_<MissionTypes>("MissionTypes")
		...
		.value("MISSION_GOTO", MISSION_GOTO)
		.value("MISSION_UPDATE_WORLD_VIEWS", MISSION_UPDATE_WORLD_VIEWS)
		.value("MISSION_SELL_SLAVE", MISSION_SELL_SLAVE)
		.value("MISSION_SHADOW", MISSION_SHADOW)
		.value("MISSION_BECOME_SLAVER", MISSION_BECOME_SLAVER)
		.value("MISSION_FREE_UNIT_SUPPORT", MISSION_BECOME_SLAVER)
		.value("MISSION_PLUNDER_CITY", MISSION_BECOME_SLAVER)
		.value("MISSION_BECOME_BARBARIAN", MISSION_BECOME_BARBARIAN)
		.value("MISSION_GREAT_JEST", MISSION_GREAT_JEST)
	...
	python::enum_<TradeableItems>("TradeableItems")
		...
		.value("TRADE_LIMITED_BORDERS", TRADE_LIMITED_BORDERS)
	...
	python::enum_<GameMessageTypes>("GameMessageTypes")
		...
		.value("GAMEMESSAGE_UPDATE_WORLD_VIEW", GAMEMESSAGE_UPDATE_WORLD_VIEW)
		.value("GAMEMESSAGE_SLAVE_REVOLT", GAMEMESSAGE_SLAVE_REVOLT)
		;
	...
	python::enum_<UnitRangeTypes>("UnitRangeTypes")
		...
		.value("UNITRANGE_UNLIMITED", UNITRANGE_UNLIMITED)
		.value("NUM_UNITRANGES", NUM_UNITRANGES)
		;

	python::enum_<WeaponTypes>("WeaponTypes")
		.value("NO_WEAPON", NO_WEAPON)
		;
