...
//
CvGlobals::CvGlobals() :
	m_iACO_SHOW_MODIFIER_LABELS(0),
	m_iACO_SHOW_SURVIVAL_ODDS(0),
	m_iACO_SHOW_ATTACKER_HEALTH_BARS(0),
	m_iACO_SHOW_DEFENDER_HEALTH_BARS(0),
	m_iACO_SHOW_BASIC_INFO(0),
	m_iACO_SHOW_EXPERIENCE_RANGE(0),
	m_iACO_SHOW_AVERAGE_HEALTH(0),
	m_iACO_SHOW_UNHARMED_ODDS(0),
	m_iACO_SHOW_UNROUNDED_EXPERIENCE(0),
	m_iACO_SHOW_SHIFT_INSTRUCTIONS(0),
	m_iACO_SHOW_ATTACKER_INFO(0),
	m_iACO_SHOW_DEFENDER_INFO(0),
	m_iACO_SHOW_DEFENCE_MODIFIERS(0),
	m_iACO_SHOW_TOTAL_DEFENCE_MODIFIER(0),
	...
	m_bACO_DEBUG(false),
	m_bACO_FORCE_ORIGINAL_ODDS(false),
	m_bACO_IGNORE_BARB_FREE_WINS(false),
	m_bACO_SWAP_VIEWS(false),
	m_bACO_MERGE_SHORT_BARS(false),
	m_bBBAI_AIR_COMBAT(false),
	m_bBBAI_HUMAN_AS_VASSAL_OPTION(false),
	m_bBBAI_HUMAN_VASSAL_WAR_BUILD(false),
	m_bBUG_BUILDING_ADDITIONAL_COMMERCE_HOVER(false),
	m_bBUG_BUILDING_ADDITIONAL_HAPPINESS_HOVER(false),
	m_bBUG_BUILDING_ADDITIONAL_HEALTH_HOVER(false),
	m_bBUG_BUILDING_ADDITIONAL_GREAT_PEOPLE_HOVER(false),
	m_bBUG_BUILDING_ADDITIONAL_PRODUCTION_HOVER(false),
	m_bBUG_BUILDING_HOVER_ACTUAL_EFFECTS(false),
	m_bBUG_BUILDING_SAVED_MAINTENANCE_HOVER(false),
	m_bBUG_CITY_SCREEN_BASE_COMMERCE_HOVER(false),
	m_bBUG_MISC_SPECIALIST_HOVER_ACTUAL_EFFECTS(false),
	...
	m_bRAPID_UNIT_CYCLING(false),
	m_bSIMPLE_SELECTION_MODE(false),
...
void CvGlobals::cacheGlobals() {
	...
	m_iACO_SHOW_DEFENCE_MODIFIERS = getDefineINT("ACO_SHOW_DEFENCE_MODIFIERS");
	m_iACO_SHOW_TOTAL_DEFENCE_MODIFIER = getDefineINT("ACO_SHOW_TOTAL_DEFENCE_MODIFIER");
	...
	m_bACO_ENABLED = getDefineBOOL("ACO_ENABLED");
	m_bACO_DEBUG = getDefineBOOL("ACO_DEBUG");
	m_bACO_FORCE_ORIGINAL_ODDS = getDefineBOOL("ACO_FORCE_ORIGINAL_ODDS");
	m_bACO_IGNORE_BARB_FREE_WINS = getDefineBOOL("ACO_IGNORE_BARB_FREE_WINS");
	m_bACO_SWAP_VIEWS = getDefineBOOL("ACO_SWAP_VIEWS");
	m_bACO_MERGE_SHORT_BARS = getDefineBOOL("ACO_MERGE_SHORT_BARS");
	m_bBUG_CITY_SCREEN_BASE_COMMERCE_HOVER = getDefineBOOL("BUG_CITY_SCREEN_BASE_COMMERCE_HOVER");
	m_bBUG_MISC_SPECIALIST_HOVER_ACTUAL_EFFECTS = getDefineBOOL("BUG_MISC_SPECIALIST_HOVER_ACTUAL_EFFECTS");
	m_bBUG_BUILDING_HOVER_ACTUAL_EFFECTS = getDefineBOOL("BUG_BUILDING_HOVER_ACTUAL_EFFECTS");
	m_bBUG_BUILDING_SAVED_MAINTENANCE_HOVER = getDefineBOOL("BUG_BUILDING_SAVED_MAINTENANCE_HOVER");
	m_bBUG_BUILDING_ADDITIONAL_HEALTH_HOVER = getDefineBOOL("BUG_BUILDING_ADDITIONAL_HEALTH_HOVER");
	m_bBUG_BUILDING_ADDITIONAL_HAPPINESS_HOVER = getDefineBOOL("BUG_BUILDING_ADDITIONAL_HAPPINESS_HOVER");
	m_bBUG_BUILDING_ADDITIONAL_PRODUCTION_HOVER = getDefineBOOL("BUG_BUILDING_ADDITIONAL_PRODUCTION_HOVER");
	m_bBUG_BUILDING_ADDITIONAL_COMMERCE_HOVER = getDefineBOOL("BUG_BUILDING_ADDITIONAL_COMMERCE_HOVER");
	m_bBUG_BUILDING_ADDITIONAL_GREAT_PEOPLE_HOVER = getDefineBOOL("BUG_BUILDING_ADDITIONAL_GREAT_PEOPLE_HOVER");
	m_bSIMPLE_SELECTION_MODE = getDefineBOOL("SIMPLE_SELECTION_MODE");
	m_bRAPID_UNIT_CYCLING = getDefineBOOL("RAPID_UNIT_CYCLING");
