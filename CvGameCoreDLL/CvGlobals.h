...
public:
	...
	inline int getSLAVERY_REVOLT_ADDRESS_COST() { return m_iSLAVERY_REVOLT_ADDRESS_COST; }
	inline int getSLAVERY_SLAVE_COST_BASE() { return m_iSLAVERY_SLAVE_COST_BASE; }
	inline int getSLAVERY_SLAVE_COST_SCALE() { return m_iSLAVERY_SLAVE_COST_SCALE; }
	inline int getSLAVERY_SETTLED_SLAVE_DEATH_CHANCE() { return m_iSLAVERY_SETTLED_SLAVE_DEATH_CHANCE; }
	inline int getSLAVERY_SETTLED_PROF_SLAVE_DEATH_CHANCE() { return m_iSLAVERY_SETTLED_PROF_SLAVE_DEATH_CHANCE; }
	inline int getSLAVERY_WORKER_PROTECT_MEMORY() { return m_iSLAVERY_WORKER_PROTECT_MEMORY; }
	inline int getDOUBLE_AGENT_MISSION_COST_MODIFIER() { return m_iDOUBLE_AGENT_MISSION_COST_MODIFIER; }
	...
	inline bool getIDW_ENABLED() { return m_bIDW_ENABLED; }
	inline bool getIDW_EMERGENCY_DRAFT_ENABLED() { return m_bIDW_EMERGENCY_DRAFT_ENABLED; }
	inline bool getIDW_BARBARIAN_INFLUENCE_ENABLED() { return m_bIDW_BARBARIAN_INFLUENCE_ENABLED; }
	inline bool getIDW_NAVAL_INFLUENCE_ENABLED() { return m_bIDW_NAVAL_INFLUENCE_ENABLED; }
	inline bool getIDW_PILLAGE_INFLUENCE_ENABLED() { return m_bIDW_PILLAGE_INFLUENCE_ENABLED; }
	inline bool getIDW_STATIONED_INFLUENCE_ENABLED() { return m_bIDW_STATIONED_INFLUENCE_ENABLED; }

	inline float getIDW_BASE_COMBAT_INFLUENCE() { return m_fIDW_BASE_COMBAT_INFLUENCE; }
	inline float getIDW_NO_CITY_DEFENDER_MULTIPLIER() { return m_fIDW_NO_CITY_DEFENDER_MULTIPLIER; }
	inline float getIDW_FORT_CAPTURE_MULTIPLIER() { return m_fIDW_FORT_CAPTURE_MULTIPLIER; }
	inline float getIDW_EXPERIENCE_FACTOR() { return m_fIDW_EXPERIENCE_FACTOR; }
	inline float getIDW_WARLORD_MULTIPLIER() { return m_fIDW_WARLORD_MULTIPLIER; }
	inline float getIDW_PLOT_DISTANCE_FACTOR() { return m_fIDW_PLOT_DISTANCE_FACTOR; }
	inline float getIDW_WINNER_PLOT_MULTIPLIER() { return m_fIDW_WINNER_PLOT_MULTIPLIER; }
	inline float getIDW_LOSER_PLOT_MULTIPLIER() { return m_fIDW_LOSER_PLOT_MULTIPLIER; }
	inline float getIDW_EMERGENCY_DRAFT_STRENGTH() { return m_fIDW_EMERGENCY_DRAFT_STRENGTH; }
	inline float getIDW_EMERGENCY_DRAFT_ANGER_MULTIPLIER() { return m_fIDW_EMERGENCY_DRAFT_ANGER_MULTIPLIER; }
	inline float getIDW_BASE_PILLAGE_INFLUENCE() { return m_fIDW_BASE_PILLAGE_INFLUENCE; }
	inline float getIDW_BASE_STATIONED_ENEMY_INFLUENCE() { return m_fIDW_BASE_STATIONED_ENEMY_INFLUENCE; }
	inline float getIDW_BASE_STATIONED_OWNER_INFLUENCE() { return m_fIDW_BASE_STATIONED_OWNER_INFLUENCE; }
...
protected:
	...
	************************************************************************************************************************/
	...
	int m_iSLAVERY_REVOLT_ADDRESS_COST;
	int m_iSLAVERY_SLAVE_COST_BASE;
	int m_iSLAVERY_SLAVE_COST_SCALE;
	int m_iSLAVERY_SETTLED_SLAVE_DEATH_CHANCE;
	int m_iSLAVERY_SETTLED_PROF_SLAVE_DEATH_CHANCE;
	int m_iSLAVERY_WORKER_PROTECT_MEMORY;
	int m_iDOUBLE_AGENT_MISSION_COST_MODIFIER;
	...
	int m_iTRIBAL_CONSCRIPT_MIN_POP;
	...
	bool m_bIDW_BARBARIAN_INFLUENCE_ENABLED;
	bool m_bIDW_NAVAL_INFLUENCE_ENABLED;
	bool m_bIDW_PILLAGE_INFLUENCE_ENABLED;
	bool m_bIDW_STATIONED_INFLUENCE_ENABLED;
	...
	float m_fIDW_BASE_STATIONED_ENEMY_INFLUENCE;
	float m_fIDW_BASE_STATIONED_OWNER_INFLUENCE;
