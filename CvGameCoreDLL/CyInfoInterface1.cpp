...
void CyInfoPythonInterface1() {
	...
	python::class_<CvTechInfo, python::bases<CvInfoBase> >("CvTechInfo")
		...
		.def("getUnitRangeModifier", &CvTechInfo::getUnitRangeModifier, "int ()")
	...
	python::class_<CvPromotionInfo, python::bases<CvInfoBase> >("CvPromotionInfo")
		...
		.def("getUnitRangeModifier", &CvPromotionInfo::getUnitRangeModifier, "int ()")
		...
		.def("getEnslaveCountChange", &CvPromotionInfo::getEnslaveCountChange, "int ()")
	...
	python::class_<CvUnitInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvUnitInfo")
		...
		.def("getNumPrereqAndTerrains", &CvUnitInfo::getNumPrereqAndTerrains, "int ()")
		.def("getNumPrereqOrTerrains", &CvUnitInfo::getNumPrereqOrTerrains, "int ()")
		.def("getNumPrereqOrBuildingClasses", &CvUnitInfo::getNumPrereqOrBuildingClasses, "int ()")
		.def("getNumPrereqVicinityAndBonus", &CvUnitInfo::getNumPrereqVicinityAndBonus, "int ()")
		...
		.def("getPrereqAndTerrain", &CvUnitInfo::getPrereqAndTerrain, "int (int i)")
		.def("getPrereqOrTerrain", &CvUnitInfo::getPrereqOrTerrain, "int (int i)")
		.def("getPrereqOrBuildingClass", &CvUnitInfo::getPrereqOrBuildingClass, "int (int i)")
		.def("getPrereqVicinityAndBonus", &CvUnitInfo::getPrereqVicinityAndBonus, "int (int i)")
		...
		.def("getPrereqWorldView", &CvUnitInfo::getPrereqWorldView, "int (int i)")
		...
		.def("isPrereqWorldView", &CvUnitInfo::isPrereqWorldView, "bool (int i)")
	...
	python::class_<CvCivicInfo, python::bases<CvInfoBase> >("CvCivicInfo")
		...
		.def("getUnitRangeModifier", &CvCivicInfo::getUnitRangeModifier, "int ()")
		...
		.def("getSpecialistCommerceChange", &CvCivicInfo::getSpecialistCommerceChange, "int (int i)")
	...
	python::class_<CvBuildingInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvBuildingInfo")
		...
		.def("getNumPrereqAndTerrains", &CvBuildingInfo::getNumPrereqAndTerrains, "int ()")
		.def("getNumPrereqOrTerrains", &CvBuildingInfo::getNumPrereqOrTerrains, "int ()")
		.def("getNumPrereqVicinityAndBonus", &CvBuildingInfo::getNumPrereqVicinityAndBonus, "int ()")
		...
		.def("getNumPrereqWorldViews", &CvBuildingInfo::getNumPrereqWorldViews, "int ()")
		...
		.def("isSlaveMarket", &CvBuildingInfo::isSlaveMarket, "bool ()")
		...
		.def("getPrereqAndTerrain", &CvBuildingInfo::getPrereqAndTerrain, "int (int i)")
		.def("getPrereqOrTerrain", &CvBuildingInfo::getPrereqOrTerrain, "int (int i)")
		.def("getPrereqVicinityAndBonus", &CvBuildingInfo::getPrereqVicinityAndBonus, "int (int i)")
		...
		.def("getPrereqWorldView", &CvBuildingInfo::getPrereqWorldView, "int (int i)")
		...
		.def("isPrereqVicinityAndBonus", &CvBuildingInfo::isPrereqVicinityAndBonus, "bool (int i)")
