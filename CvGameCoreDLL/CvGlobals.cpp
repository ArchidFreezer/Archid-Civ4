...
CvGlobals::CvGlobals() :
	...
	m_iFORT_ATTACK_DAMAGE_CAP(60),
	m_iFORT_ATTACK_BASE_DAMAGE(15),
	m_iSLAVERY_REVOLT_ADDRESS_COST(100),
	m_iSLAVERY_SLAVE_COST_BASE(2),
	m_iSLAVERY_SLAVE_COST_SCALE(120),
	m_iSLAVERY_SETTLED_SLAVE_DEATH_CHANCE(5),
	m_iSLAVERY_SETTLED_PROF_SLAVE_DEATH_CHANCE(1),
	m_iSLAVERY_WORKER_PROTECT_MEMORY(25),
	m_iDOUBLE_AGENT_MISSION_COST_MODIFIER(50),
	m_iDOUBLE_AGENT_CREATE_CHANCE(5),
	m_iIDW_INFLUENCE_RADIUS(2),
	m_iIDW_EMERGENCY_DRAFT_MIN_POPULATION(2),
	m_iTILES_PER_SPAWN(6),
	m_iTRIBAL_CONSCRIPT_MIN_POP(3),
	m_iMIN_ROUT_DAMAGE(750), // Remember that max health is 1000, so this is 75%
	m_iMIN_DAMAGE_MORALE(10),
	m_iHEAL_XP(1),
	...
	m_bFORT_ATTACK_CITIES_ALSO(false),
	m_bIDW_ENABLED(false),
	m_bIDW_EMERGENCY_DRAFT_ENABLED(false),
	m_bIDW_BARBARIAN_INFLUENCE_ENABLED(false),
	m_bIDW_NAVAL_INFLUENCE_ENABLED(false),
	m_bIDW_PILLAGE_INFLUENCE_ENABLED(false),
	m_bIDW_STATIONED_INFLUENCE_ENABLED(false),

	m_fIDW_BASE_COMBAT_INFLUENCE(4.0f),
	m_fIDW_NO_CITY_DEFENDER_MULTIPLIER(2.5f),
	m_fIDW_FORT_CAPTURE_MULTIPLIER(2.0f),
	m_fIDW_EXPERIENCE_FACTOR(0.03f),
	m_fIDW_WARLORD_MULTIPLIER(1.3f),
	m_fIDW_PLOT_DISTANCE_FACTOR(0.2f),
	m_fIDW_WINNER_PLOT_MULTIPLIER(1.0f),
	m_fIDW_LOSER_PLOT_MULTIPLIER(1.0f),
	m_fIDW_EMERGENCY_DRAFT_STRENGTH(0.25f),
	m_fIDW_EMERGENCY_DRAFT_ANGER_MULTIPLIER(0.5f),
	m_fIDW_BASE_PILLAGE_INFLUENCE(2.0f),
	m_fIDW_BASE_STATIONED_ENEMY_INFLUENCE(0.7f),
	m_fIDW_BASE_STATIONED_OWNER_INFLUENCE(2.0f),
	...
	m_szSLAVER_EARLY_UNIT_ART_DEF(NULL),
	m_szSLAVER_MIDDLE_UNIT_ART_DEF(NULL),
	m_szSLAVER_LATE_UNIT_ART_DEF(NULL),
	m_szBARBARIAN_EARLY_UNIT_ART_DEF(NULL),
	m_szBARBARIAN_MIDDLE_UNIT_ART_DEF(NULL),
	m_szBARBARIAN_LATE_UNIT_ART_DEF(NULL),
...
void CvGlobals::cacheGlobals() {
	...
	m_iSLAVERY_REVOLT_ADDRESS_COST = getDefineINT("SLAVERY_REVOLT_ADDRESS_COST", m_iSLAVERY_REVOLT_ADDRESS_COST);
	m_iSLAVERY_SLAVE_COST_BASE = getDefineINT("SLAVERY_SLAVE_COST", m_iSLAVERY_SLAVE_COST_BASE);
	m_iSLAVERY_SLAVE_COST_SCALE = getDefineINT("SLAVERY_SLAVE_COST", m_iSLAVERY_SLAVE_COST_SCALE);
	m_iSLAVERY_SETTLED_SLAVE_DEATH_CHANCE = getDefineINT("SLAVERY_SETTLED_SLAVE_DEATH_CHANCE", m_iSLAVERY_SETTLED_SLAVE_DEATH_CHANCE);
	m_iSLAVERY_SETTLED_PROF_SLAVE_DEATH_CHANCE = getDefineINT("SLAVERY_SETTLED_PROF_SLAVE_DEATH_CHANCE", m_iSLAVERY_SETTLED_PROF_SLAVE_DEATH_CHANCE);
	m_iSLAVERY_WORKER_PROTECT_MEMORY = getDefineINT("SLAVERY_WORKER_PROTECT_MEMORY", m_iSLAVERY_WORKER_PROTECT_MEMORY);
	...
	m_iTGA_RELIGIONS = getDefineINT("GAMEFONT_TGA_RELIGIONS");
	m_iTGA_CORPORATIONS = getDefineINT("GAMEFONT_TGA_CORPORATIONS");
	m_iREHOME_PERCENT_CHANCE = getDefineINT("REHOME_PERCENT_CHANCE");
	...
	m_iFORT_ATTACK_DAMAGE_CAP = getDefineINT("FORT_ATTACK_DAMAGE_CAP");
	m_iFORT_ATTACK_BASE_DAMAGE = getDefineINT("FORT_ATTACK_BASE_DAMAGE");
	m_iDOUBLE_AGENT_MISSION_COST_MODIFIER = getDefineINT("DOUBLE_AGENT_MISSION_COST_MODIFIER");
	m_iDOUBLE_AGENT_CREATE_CHANCE = getDefineINT("DOUBLE_AGENT_CREATE_CHANCE");
	...
	m_iTILES_PER_SPAWN = getDefineINT("TILES_PER_SPAWN", m_iTILES_PER_SPAWN);
	m_iTRIBAL_CONSCRIPT_MIN_POP = GC.getDefineINT("TRIBAL_CONSCRIPT_MIN_CITY_POPULATION", m_iTRIBAL_CONSCRIPT_MIN_POP);
	m_iMIN_ROUT_DAMAGE = GC.getDefineINT("MIN_ROUT_DAMAGE", m_iMIN_ROUT_DAMAGE);
	m_iMIN_DAMAGE_MORALE = GC.getDefineINT("MIN_DAMAGE_MORALE", m_iMIN_DAMAGE_MORALE);
	m_iHEAL_XP = GC.getDefineINT("HEAL_XP", m_iHEAL_XP);
	...
	m_bUSE_AI_CHOOSE_PRODUCTION_CALLBACK = getDefineBOOL("USE_AI_CHOOSE_PRODUCTION_CALLBACK");
	m_bUSE_AI_DO_WAR_CALLBACK = getDefineBOOL("USE_AI_DO_WAR_CALLBACK");
	m_bUSE_AI_CHOOSE_TECH_CALLBACK = getDefineBOOL("USE_AI_CHOOSE_TECH_CALLBACK");
	m_bUSE_DO_GROWTH_CALLBACK = getDefineBOOL("USE_DO_GROWTH_CALLBACK");
	m_bUSE_DO_CULTURE_CALLBACK = getDefineBOOL("USE_DO_CULTURE_CALLBACK");
	m_bUSE_DO_PLOT_CULTURE_CALLBACK = getDefineBOOL("USE_DO_PLOT_CULTURE_CALLBACK");
	m_bUSE_DO_PRODUCTION_CALLBACK = getDefineBOOL("USE_DO_PRODUCTION_CALLBACK");
	m_bUSE_DO_RELIGION_CALLBACK = getDefineBOOL("USE_DO_RELIGION_CALLBACK");
	m_bUSE_DO_GREAT_PEOPLE_CALLBACK = getDefineBOOL("USE_DO_GREAT_PEOPLE_CALLBACK");
	m_bUSE_DO_MELTDOWN_CALLBACK = getDefineBOOL("USE_DO_MELTDOWN_CALLBACK");
	m_bUSE_DO_PILLAGE_GOLD_CALLBACK = getDefineBOOL("USE_DO_PILLAGE_GOLD_CALLBACK");
	m_bUSE_GET_EXPERIENCE_NEEDED_CALLBACK = getDefineBOOL("USE_GET_EXPERIENCE_NEEDED_CALLBACK");
	m_bUSE_UNIT_UPGRADE_PRICE_CALLBACK = getDefineBOOL("USE_UNIT_UPGRADE_PRICE_CALLBACK");
	m_bUSE_DO_COMBAT_CALLBACK = getDefineBOOL("USE_DO_COMBAT_CALLBACK");
	m_bANIMALS_SPAWN_WITH_BARBARIANS = getDefineBOOL("ANIMALS_SPAWN_WITH_BARBARIANS", m_bANIMALS_SPAWN_WITH_BARBARIANS);
	m_bFORT_ATTACK_CITIES_ALSO = getDefineBOOL("FORT_ATTACK_CITIES_ALSO");
	m_bIDW_ENABLED = getDefineBOOL("IDW_ENABLED");
	m_bIDW_EMERGENCY_DRAFT_ENABLED = getDefineBOOL("IDW_EMERGENCY_DRAFT_ENABLED");
	m_bIDW_BARBARIAN_INFLUENCE_ENABLED = getDefineBOOL("IDW_BARBARIAN_INFLUENCE_ENABLED");
	m_bIDW_NAVAL_INFLUENCE_ENABLED = getDefineBOOL("IDW_NAVAL_INFLUENCE_ENABLED");
	m_bIDW_PILLAGE_INFLUENCE_ENABLED = getDefineBOOL("IDW_PILLAGE_INFLUENCE_ENABLED");
	m_bIDW_STATIONED_INFLUENCE_ENABLED = getDefineBOOL("IDW_STATIONED_INFLUENCE_ENABLED");
	...
	m_fIDW_BASE_STATIONED_ENEMY_INFLUENCE = getDefineFLOAT("IDW_BASE_STATIONED_ENEMY_INFLUENCE");
	m_fIDW_BASE_STATIONED_OWNER_INFLUENCE = getDefineFLOAT("IDW_BASE_STATIONED_OWNER_INFLUENCE");

	// BBAI Options
	m_bBBAI_AIR_COMBAT = getDefineBOOL("BBAI_AIR_COMBAT");
	m_bBBAI_HUMAN_VASSAL_WAR_BUILD = getDefineBOOL("BBAI_HUMAN_VASSAL_WAR_BUILD");
	m_iBBAI_DEFENSIVE_PACT_BEHAVIOR = getDefineINT("BBAI_DEFENSIVE_PACT_BEHAVIOR");
	m_bBBAI_HUMAN_AS_VASSAL_OPTION = getDefineBOOL("BBAI_HUMAN_AS_VASSAL_OPTION");
	...
	// Tech Diffusion
	m_bTECH_DIFFUSION_ENABLE = getDefineBOOL("TECH_DIFFUSION_ENABLE");
	...
	m_bLFBEnable = getDefineBOOL("LFB_ENABLE");
	...
	m_bLFBUseSlidingScale = getDefineBOOL("LFB_USESLIDINGSCALE");
	...
	m_szSLAVER_EARLY_UNIT_ART_DEF = getDefineSTRING("SLAVER_EARLY_UNIT_ART_DEF");
	m_szSLAVER_MIDDLE_UNIT_ART_DEF = getDefineSTRING("SLAVER_MIDDLE_UNIT_ART_DEF");
	m_szSLAVER_LATE_UNIT_ART_DEF = getDefineSTRING("SLAVER_LATE_UNIT_ART_DEF");
	m_szBARBARIAN_EARLY_UNIT_ART_DEF = getDefineSTRING("BARBARIAN_EARLY_UNIT_ART_DEF");
	m_szBARBARIAN_MIDDLE_UNIT_ART_DEF = getDefineSTRING("BARBARIAN_MIDDLE_UNIT_ART_DEF");
	m_szBARBARIAN_LATE_UNIT_ART_DEF = getDefineSTRING("BARBARIAN_LATE_UNIT_ART_DEF");
}

bool CvGlobals::getDefineBOOL(const char* szName, bool bDefault) const {
	int iResult = 0;
	if (GC.getDefinesVarSystem()->GetValue(szName, iResult)) {
		return iResult != 0;
	} else {
		return bDefault;
	}
...
int CvGlobals::getDefineINT(const char* szName, int iDefault) const {
	int iResult = 0;
	if (GC.getDefinesVarSystem()->GetValue(szName, iResult)) {
		return iResult;
	} else {
...
float CvGlobals::getDefineFLOAT(const char* szName, float fDefault) const {
	float fResult = 0.0;
	if (GC.getDefinesVarSystem()->GetValue(szName, fResult)) {
		return fResult;
	} else {
		return fDefault;
	}
...
const char* CvGlobals::getDefineSTRING(const char* szName, const char* szDefault) const {
	const char* szResult = NULL;
	if (GC.getDefinesVarSystem()->GetValue(szName, szResult)) {
		return szResult;
	} else {
		return szDefault;
	}
