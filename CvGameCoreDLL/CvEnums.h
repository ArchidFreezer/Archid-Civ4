...
enum WidgetTypes					// Exposed to Python
{
	...
	WIDGET_HELP_FOREST_YIELD_CHANGE,
	WIDGET_HELP_RIVER_YIELD_CHANGE,
	WIDGET_HELP_SEA_YIELD_CHANGE,
	WIDGET_HELP_CAPTURE_CITIES,
	WIDGET_HELP_FIRST_FREE_UNIT,
	WIDGET_HELP_OBSOLETE_BUILD,
	WIDGET_HELP_EMBASSY,
	WIDGET_HELP_LIMITED_BORDERS,
...
enum ButtonPopupTypes			// Exposed to Python
{
	...
	BUTTONPOPUP_GOTO_CITY,
	BUTTONPOPUP_TOGGLE_WORLD_VIEW,
	BUTTONPOPUP_TOGGLE_ANY_WORLD_VIEW,
	BUTTONPOPUP_SLAVE_REVOLT,
...
enum PlayerOptionTypes			// Exposed to Python
{
	...
	PLAYEROPTION_AVOID_UNHAPPY_GROWTH,
	PLAYEROPTION_AVOID_UNHEALTHY_GROWTH,
...
enum UnitAITypes			// Exposed to Python
{
	...
	UNITAI_GATHERER,
	UNITAI_HUNTER,
	UNITAI_BARBARIAN_LEADER,
	UNITAI_BARBARIAN,
	UNITAI_BARBARIAN_ATTACK_CITY,
...
enum MissionTypes				// Exposed to Python
{
	...
	MISSION_GOTO,
	MISSION_UPDATE_WORLD_VIEWS,
	MISSION_SELL_SLAVE,
	MISSION_SHADOW,
	MISSION_BECOME_SLAVER,
	MISSION_FREE_UNIT_SUPPORT,
	MISSION_PLUNDER_CITY,
	MISSION_BECOME_BARBARIAN,
...
enum GameMessageTypes				// Exposed to Python
{
	...
	GAMEMESSAGE_UPDATE_WORLD_VIEW,
	GAMEMESSAGE_MOD_NET_MESSAGE,
	GAMEMESSAGE_SLAVE_REVOLT,
};
...
enum SlaveRevoltActions {
	NO_SLAVE_REVOLT_ACTION,
	SLAVE_REVOLT_SUPPRESS,
	SLAVE_REVOLT_ADDRESS,
	SLAVE_REVOLT_IGNORE,
	NUM_SLAVE_REVOLT_ACTIONS
};
